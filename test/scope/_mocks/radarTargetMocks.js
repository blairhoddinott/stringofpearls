...
const cloneAircraftModelMock = (aircraftModel) => Object.assign(
    Object.create(Object.getPrototypeOf(aircraftModel)),
    aircraftModel
);

export const createRadarTargetArrivalMock = () => new RadarTargetModel(
    THEME.DEFAULT,
    cloneAircraftModelMock(ARRIVAL_AIRCRAFT_MODEL_MOCK)
);
export const createRadarTargetDepartureMock = () => new RadarTargetModel(
    THEME.DEFAULT,
    cloneAircraftModelMock(DEPARTURE_AIRCRAFT_MODEL_MOCK)
);
