...
- [ ] Modernize the application architecture; Phase 4 now has a browser-free per-session `SimulationContext`, isolated event dispatch, and an explicit deterministic `tick(delta)` clock boundary.
