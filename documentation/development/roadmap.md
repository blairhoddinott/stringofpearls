...
- [ ] Modernize the application architecture; Phase 4 now has a browser-free per-session `SimulationContext`, isolated event dispatch, deterministic time, and context-owned game timers.
