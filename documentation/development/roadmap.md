...
- [ ] Modernize the application architecture; Phase 4 now has a browser-free per-session `SimulationContext`, isolated event dispatch, and a deterministic `tick(delta)` clock with pause and timewarp policy.
